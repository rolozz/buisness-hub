NotificationService - это микросервис на Java, который обрабатывает отправку уведомлений. Этот проект использует Spring Boot и включает документацию API с помощью Swagger (Springdoc OpenAPI).
