...
import business.hub.service.BookingCancellationEmailServiceImpl;
...
public class BookingCancellationServiceTest {
    ...
    @InjectMocks
    private BookingCancellationEmailServiceImpl bookingCancellationEmailService;
    ...
    void sendCancellationEmailTest() throws TemplateException, IOException {
        ...
        when(emailTemplateService.processTemplate("booking_cancellation", model)).thenReturn("template");
